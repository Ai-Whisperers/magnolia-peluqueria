...
const FAQ_ITEMS_ES = [
  { q: "¿Cuáles son los horarios?", a: "Martes a sábado de 9:00 a 19:00. Lunes y domingos cerrados. Podés reservar por Messaging para coordinar tu turno." },
  { q: "¿Aceptan walk-ins?", a: "Preferimos con cita previa para garantizarte atención personalizada. Escribinos por Messaging y te confirmamos en minutos." },
  ...
  { q: "¿Trabajan con extensiones?", a: "Sí, ofrecemos colocación y mantenimiento de extensiones capilares. Consultá por Messaging para coordinar." },
  ...
  { q: "¿Cómo reservo mi turno?", a: `La forma más rápida es por Messaging: ${businessData("es").phoneFormatted}. Te respondemos en menos de 5 minutos y coordinamos el mejor horario.` },
  { q: "¿Tienen estacionamiento?", a: "Estamos en zona céntrica con fácil acceso. Consultanos por Messaging y te enviamos opciones de estacionamiento cercanas." },
...
const FAQ_ITEMS_EN = [
  { q: "What are your hours?", a: "Tuesday to Saturday, 9:00 AM to 7:00 PM. Closed Mondays and Sundays. Book via Messaging to schedule your appointment." },
  { q: "Do you accept walk-ins?", a: "We prefer appointments to ensure personalized attention. Message us on Messaging and we'll confirm in minutes." },
  ...
  { q: "Do you work with extensions?", a: "Yes, we offer extension application and maintenance. Message us on Messaging to schedule." },
  ...
  { q: "How do I book an appointment?", a: `The fastest way is via Messaging: ${businessData("en").phoneFormatted}. We reply in under 5 minutes and coordinate the best time.` },
  { q: "Do you have parking?", a: "We are in a central area with easy access. Message us on Messaging and we'll send nearby parking options." },
