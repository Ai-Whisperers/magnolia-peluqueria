...
export const metadata = { title: "Nosotros — Magnolia Peluquería" }
    ...
    <>
      ...
      <main className="bg-background py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="font-heading text-4xl font-bold text-primary text-center mb-4">Sobre Magnolia Peluquería</h1>
          <p className="text-center text-foreground-light max-w-2xl mx-auto mb-16 text-lg">
            Somos una peluquería profesional en Asunción, apasionados por realzar tu belleza. Ofrecemos cortes, coloración y tratamientos capilares con las mejores técnicas y productos del mercado.
          </p>
